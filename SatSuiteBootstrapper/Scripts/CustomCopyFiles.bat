...
mkdir "C:\Users\Public\Documents\SatSuite\Harvested"


:: Copy one file to the target directory
copy "C:\Program Files (x86)\SatSuite\Harvested\CppProject.ilk" "C:\Users\Public\Documents\SatSuite\Harvested\CppProject.ilk" /Y


:: How to copy an entire directory (xcopy)
:: xcopy "C:\TEMP\Textfiles" "C:\Users\Public\Documents\SatSuite\Textfiles" /S /Q /Y /I
